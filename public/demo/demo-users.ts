...
const domain = "dev.icc-health.com";

export const nameAlice = "Alice";
export const uriAlice = "sip:1008@dev.icc-health.com:7443";
export const webSocketServerAlice = "wss://dev.icc-health.com:7443";

export const nameBob = "Bob";
export const uriBob = "sip:1007@dev.icc-health.com";
export const webSocketServerBob = "wss://dev.icc-health.com:7443";
