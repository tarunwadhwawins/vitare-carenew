    ...
    <a-row>
        <a-col :span=12>
            <div class="templateType">
                <div>User Type : <span> {{questionnaireResponseDetails ? questionnaireResponseDetails.entity :''}}</span></div>
        ...
        <a-col :span="12">
            ...
            <div class="templateType right">
                <div>Status : <span> {{questionnaireResponseDetails ? questionnaireResponseDetails.status :''}}</span></div>
                <div>Filled Date : <span> {{questionnaireResponseDetails ? questionnaireResponseDetails.createdAt :''}}</span></div>
                <div>Score : <a><span @click="getResponse" :title="data ? data[0].program:''"> {{data ? data[0].program.substring(0,10)+'...':'score'}}</span></a></div>
            </div>
        </a-col>
    </a-row>
