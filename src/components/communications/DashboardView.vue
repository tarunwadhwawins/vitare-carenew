    ...
    <a-col :sm="12" :xs="24">
      <a-card :title="$t('communications.populateWaitingRoom')" class="common-card">
        <a-tabs v-model:activeKey="activeKey">
          <PopulateWaitingRoomTab key="1" tab="New Requests" :columns="newRequestsColumns" :dataSource="newRequestsData" linkTo="patients-summary"/>
          <PopulateWaitingRoomTab key="2" tab="Future Appointments" :columns="futureAppointmentsColumns" :dataSource="futureAppointmentsData" linkTo="patients-summary"/>
        </a-tabs>
      </a-card>
    </a-col>
    ...
    <a-col :sm="12" :xs="24">
      <a-card :title="$t('communications.communicationType')" class="common-card">
        <ApexChart
          ...
          :series="communicationTypeSeries" />
      </a-card>
    </a-col>
