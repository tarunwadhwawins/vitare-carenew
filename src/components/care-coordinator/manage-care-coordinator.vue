                ...
                <a-row>
                    <a-col :span="24">
                        <h2 class="pageTittle">
                            ...
                            <div class="commonBtn">
                                <a-button class="btn primaryBtn" @click="showModal">Add New Coordinator</a-button>
                            </div>
                        </h2>
                    </a-col>
                </a-row>
                ...
                <div class="steps-content" v-if="steps[current].title == 'Roles'">
                    <a-row :gutter="24">
                        <a-col :span="24">
                            <div class="form-group">
                                <label>Role</label>
                                <a-select v-model:value="selectedItems" mode="multiple" placeholder="Please Select Roles" style="width: 100%" :options="filteredOptions.map(item => ({ value: item }))">
                                </a-select>
                            </div>
                        </a-col>
                    </a-row>
