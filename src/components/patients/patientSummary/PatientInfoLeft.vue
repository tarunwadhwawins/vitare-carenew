...
export default defineComponent({
  ...
  setup() {
    ...
    const handleOk = ({ modal, value }) => {
      if (modal && value) {
        addEmergencyContactModalVisible.value =
          modal == "addEmergencyContact" ? value : false;
        // addPhysicianModalVisible.value = modal == 'addPhysician' ? value : false;
        addfamilyMembersVisible.value =
          modal == "addResponsiblePerson" ? value : false;
        ...
        familyMembersModalVisible.value =
          modal == "familyMembersList" ? value : false;
        // physiciansModalVisible.value = modal == 'physiciansList' ? value : false;
        emergencyContactsModalVisible.value =
          modal == "emergencyContactsList" ? value : false;
        deviceDetailVisible.value = modal == "devicesListing" ? value : false;
        coordinatorsListingModalVisible.value =
          modal == "deleteCareTeam" ? value : false;
        addfamilyMembersVisible.value =
          modal == "addFamilyMember" ? value : false;
      } else {
