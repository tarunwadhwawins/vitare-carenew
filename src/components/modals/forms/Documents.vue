<template>
<a-form ref="formRef" scrollToFirstError=true :model="documents" name="basic" autocomplete="off" layout="vertical" @finish="addDocument" @finishFailed="onFinishFailed">
    <a-row :gutter="24">
        <a-col :sm="12" :xs="24">
        ...
        <a-col :sm="12" :xs="24">
            <div class="form-group">
                <a-form-item :label="$t('global.tags')" name="tags" :rules="[{ required: true, message: $t('global.tags')+' '+$t('global.validation') }]">
                    ...
                    <GlobalCodeDropDown @change="changedValue" size="large" v-model:value="documents.tags" mode="multiple" :dataId="12" @handleGlobalChange="handleGlobalChange($event,'documents.tags')" />
