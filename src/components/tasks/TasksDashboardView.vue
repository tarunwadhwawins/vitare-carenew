<template>
  ...
  >
    <a-col
      ...
      :sm="8"
      :xs="12"
      v-for="status in tasks.taskStatus"
      :key="status.id"
    >
      <FilterCard
        :filterCount="CompletedTasksFilterCount"
        :count="status.total ? status.total : 0"
        :color="status.color"
        class="blockLists five"
        :heading="status.text"
      />
    </a-col>
  </a-row>
    ...
    <a-col :xl="8" :sm="12" :xs="24">
      <a-card title="Task Priority" class="common-card grapCardWrap">
        ...
        <ApexChart
          type="bar"
          :height="250"
          v-if="tasks.taskPriority"
          :options="tasks.taskPriority.optionPriority"
          :series="tasks.taskPriority.seriesPriority"
        />
      </a-card>
    </a-col>
    <a-col :xl="8" :sm="12" :xs="24">
      <a-card title="Team Member" class="common-card grapCardWrap">
        ...
        <ApexChart
          type="bar"
          :height="250"
          v-if="tasks.taskTeamMember"
          :options="tasks.taskTeamMember.optionTeamMember"
          :series="tasks.taskTeamMember.seriesTeamMember"
        />
      </a-card>
    </a-col>
    <a-col :xl="8" :sm="12" :xs="24">
      <a-card title="Task Completion over" class="common-card grapCardWrap">
        <ApexChart
          type="area"
          v-if="tasks.completionOptions"
          :height="275"
          :options="tasks.completionOptions"
          :series="tasks.completionSeries"
        />
      </a-card>
    </a-col>
    <a-col :xl="8" :sm="12" :xs="24">
      <a-card title="All Tasks" class="common-card grapCardWrap">
        ...
        <ApexChart
          type="pie"
          v-if="tasks.completedAllTask"
          :height="275"
          :options="tasks.completedAllTask"
          :series="tasks.incompleteAllTask"
        />
      </a-card>
    </a-col>
    <a-col :xl="8" :sm="12" :xs="24">
      <a-card title="Category View" class="common-card grapCardWrap">
        ...
        <ApexChart
          type="pie"
          v-if="tasks.taskCategory.premium"
          :height="275"
          :options="tasks.taskCategory.premium"
          :series="tasks.taskCategory.business"
        />
      </a-card>
    </a-col>
    <a-col :xl="8" :sm="12" :xs="24">
