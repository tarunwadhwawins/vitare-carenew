<template>
<a-modal max-width="1140px" width="80%" :title="'Reset Password'" centered :footer="false" :maskClosable="false" @cancel="closeModal()">
<a-form :model="resetPassword" :scrollToFirstError="true" ref="formRef" class="basic" name="basic" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" autocomplete="off" layout="vertical" @finish="personalInfo" @finishFailed="onFinishFailed">
    <div class="common-bg">
            <a-row>
              <a-col :span="24">
