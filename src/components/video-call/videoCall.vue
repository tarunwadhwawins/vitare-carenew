                ...
                <div class="common-bg">
                    ...
                    <div class="videoWrapper">
                        ...
                        <div class="callRightWrapper" id="detailDiv">
                            ...
                            <div class="body">
                                <a-row>
                                    <a-col :span="4" :class="timelineDetailVisible==true?'bold':''">
                                    ...
                                    <a-col :span="4" :class="notesDetailVisible==true?'bold':''">
                                    ...
                                    <a-col :span="4" :class="documentDetailVisible==true?'bold':''">
                                    ...
                                    <a-col :span="4" @click="showVitalssModal" :class="patientVitalsVisible==true?'bold':''">
                                ...
                                <a-row class="overFlow">
                                    ...
                                    <NotesDetail v-if="notesDetailVisible==true" :pId="getVideoDetails?getVideoDetails.patientDetailed.id:acceptVideoCallDetails.patient.id" />
