...
await ServiceMethodService.common('post', API_ENDPOINTS['addQuestionnaire'], null, data)
...
await ServiceMethodService.common('get', API_ENDPOINTS['addQuestionnaire'], null, data)
...
await ServiceMethodService.common('get', API_ENDPOINTS['addQuestionnaire'], id, null)
...
await ServiceMethodService.common('put', API_ENDPOINTS['addQuestionnaire'], null, data)
...
await ServiceMethodService.common('delete', API_ENDPOINTS['addQuestionnaire'], id, null)
